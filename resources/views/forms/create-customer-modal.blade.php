          ...
          <div class="modal-body">
            ...
            <div class="row">
              ...
              <div class="col-md-6 mb-2">
                ...
                <input type="text" name="national_id" class="form-control" autocomplete="off" required maxlength="16">
              </div>
              <div class="col-md-6 mb-2">
                <label>Nama Pasangan</label>
                <input type="text" name="partner_name" autocomplete="off" class="form-control">
              </div>
              <div class="col-md-6 mb-2">
                <label>Nomor KTP Pasangan</label>
                <input type="text" name="partner_national_id" autocomplete="off" class="form-control" maxlength="16">
              </div>
              <div class="col-md-6 mb-2">
              ...
              <div class="col-md-6 mb-2">
                ...
                <input type="date" name="partner_birth_date" autocomplete="off" class="form-control">
              </div>
